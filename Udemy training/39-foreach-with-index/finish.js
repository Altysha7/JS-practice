...
const cityInfo = ({el, index}) => 
    `${el} is at the index ${index} in the myCities array`

myCities.forEach((el, index) => console.log(cityInfo({index, el})))


// myCities.forEach((el) => console.log(el))